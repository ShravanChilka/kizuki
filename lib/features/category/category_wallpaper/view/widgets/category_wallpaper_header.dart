...
import 'category_wallpaper_header_title.dart';
...
class CategoryWallpaperHeader extends StatelessWidget {
  const CategoryWallpaperHeader({super.key});
      ...
      children: [
        Container(
          ...
          child: const Align(
            ...
            child: CategoryWallpaperHeaderTitle(),
          ),
        ),
        const Positioned(
          right: 20,
